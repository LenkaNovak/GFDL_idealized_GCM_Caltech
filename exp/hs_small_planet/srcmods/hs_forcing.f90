...
use     constants_mod, only: KAPPA, CP_air, GRAV, rdgas, rvgas, hlv, tfreeze,pi, omega, radius, xi_sp
...
!-------------------- namelist -----------------------------------------
   ...
   real :: t_zero=315., t_strat=200., delh=60., delv=10., eps=0., sigma_b=0.7, lat0_s=0.0
   real :: P00 = 1.e5
...
!-----------------------------------------------------------------------
     ...
     sin_lat_s, sin_lat_2_s, cos_lat_2_s
...
!------------latitudinal constants--------------------------------------
      ...
      sin_lat_s  (:,:) = sin(lat(:,:) - lat0_s*3.14/180.0)
      sin_lat_2_s(:,:) = sin_lat_s(:,:)*sin_lat_s(:,:)
      cos_lat_2_s(:,:) = 1.0-sin_lat_2_s(:,:)
      
      t_star(:,:) = t_zero - delh*sin_lat_2(:,:) - delh*2.0 * sin_lat(:,:)*sin(lat0_s*3.14/180.0)
      tstr  (:,:) = t_strat - eps*sin_lat(:,:)   - delh*2.0 * sin_lat(:,:)*sin(lat0_s*3.14/180.0)
