...
! ln<
! xi_sp rescaling factor for small planet exps
real, public, parameter :: xi_sp = 20.0


real, public, parameter :: RADIUS = 6371.0e3 / xi_sp   
real, public, parameter :: OMEGA  = 7.292e-5 * xi_sp
! >ln
...
! mix-ing ratio of molecular oxygen in air
! </DATA>
