# exec(open("test_data_albedo_equinox_hydro_comparison_allyrs.py").read())
...
yr_range = ["1080", "1440", '1800'] # "%04d"%day_list[-1]
...
# save variables
exp_name, run_name = ("uf_tests_hpc_businger_albedo_eqnx_hydro", "uf_tests_hpc_businger_albedo_eqnx_hydro_albedo02rcrit8_0_2")
save_basic_diags(exp_name, run_name, day_list, yr_range, save_variable_list, h5_dir = "data/", h5_name = "basic_hydro_vars")

exp_name, run_name = ("uf_tests_hpc_albedo_eqnx_hydro", "uf_tests_hpc_albedo_eqnx_hydro_albedo02rcrit8_0_4")
save_basic_diags(exp_name, run_name, day_list, yr_range, save_variable_list, h5_dir = "data/", h5_name = "basic_hydro_vars_c")

# bus run
lat, lon, sig, v, u, T, Th1, uv, vT, TT, eke, u_vrtcl_flux, pot_temp_vrtcl_flux, z1, T1, u1, lh_flux_sfc, sh_flux_sfc, T_sfc, u_02, v_02 = read_basic_diags(yr_range, h5_name = "basic_hydro_vars")

# control run
lat_c, lon_c, sig_c, v_c, u_c, T_c, Th1_c, uv_c, vT_c, TT_c, eke_c, u_vrtcl_flux_c, pot_temp_vrtcl_flux_c, z1_c, T1_c, u1_c, lh_flux_sfc_c, sh_flux_sfc_c, T_sfc_c, u_02_c, v_02_c  = read_basic_diags(yr_range, h5_name = "basic_hydro_vars_c")
...
plt.savefig("circ1_eqnx_hydro_allyrs.png")
...
plt.savefig("circ1_eqnx_hydro_diff_allyrs.png")
...
plt.savefig("circ2_eqnx_hydro_allyrs.png")
...
plt.savefig("circ2_eqnx_hydro_diff_allyrs.png")
...
plt.savefig("test_data_albedo_eqnx_hydro_comparison_allyrs.png")
...
plt.title('sensible (W/m2)')
plt.savefig("test_data_albedo_eqnx_hydro_comparison_diff_allyrs.png")
...
plt.xlabel('ri_bulk')
# plt.ylim([0,0.2e6])
plt.savefig("hist_albedo_eqnx_hydro_allyrs.png")
...
plt.xlabel('ri_bulk')
plt.ylim([0,0.02e6])
plt.savefig("hist_albedo_eqnx_hydro_polar_allyrs.png")
...
plt.xlabel('ri_bulk')
plt.ylim([0,0.02e6])
plt.savefig("hist_albedo_eqnx_hydro_polar_sh_allyrs.png")
